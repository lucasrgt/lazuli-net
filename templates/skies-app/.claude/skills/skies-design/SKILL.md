---
name: skies-design
description: Use when creating or modifying any UI in an Skies app — screens (*.view.tsx), ui/ primitives, forms, or visual styling. Loads the design constitution and the matching recipe, then enforces the exit ritual (lint + render + visual self-review).
---
